...
const BestCuisinesContainer = ({ restaurant }) => {
  const { bestCuisines } = restaurant || {};
  ...
  return (
    <Fragment>
      <h1 className="font-bold text-2xl">{bestCuisines?.title}</h1>
      <div className="w-3/3 py-4 px-2 my-2  ">
        ...
        {bestCuisines?.brands?.length > indexValue && (
...
BestCuisinesContainer.propTypes = {
  restaurant: PropTypes,
};

export default BestCuisinesContainer;
