    ...
    <>
      <>
        {itemCard.length > 0 && (
          <Link to="/checkout">
            {" "}
            <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 bg-green-700 text-white w-2/3 justify-between flex p-4 shadow-lg z-50 hover:cursor-pointer">
              <div className="font-semibold">{itemCard.length} items added</div>
...
RestaurantDetail.propTypes = {
  RestaurantDetailInfo: PropTypes,
};
